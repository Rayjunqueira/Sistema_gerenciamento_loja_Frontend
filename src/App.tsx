...
import DeleteDebt from './pages/DeleteDebt';
    ...
    <div>
      {showNavigation && <Navegation />}
        <Routes>
          ...
          <Route path='/adddebt/:id' element={<RequireAuth><AddDebt /></RequireAuth>} />
          <Route path='/removedebt/:id' element={<RequireAuth><DeleteDebt /></RequireAuth>} />
